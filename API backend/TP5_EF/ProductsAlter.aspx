<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ProductsAlter.aspx.cs" Inherits="TP5_EF.ProductsEdit" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Button ID="btnEditar" OnClick="btnEditar_Click" Text="Editar" runat="server" />
